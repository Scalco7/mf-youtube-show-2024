...
import { IVideoDataResponse } from './scripts/api/listVideosByTitle/listVideosByTitle.interface';
...
list.videos.forEach((video: IVideoDataResponse) => {
    const videoHtml = `
        <post class="video-box${video.favorite ? ' favorite-video' : ''}">
